...
-- NOTE: item ids 9 (stone) and 10 (shard_magic) are already taken by base/enchant
--   migrations, so the farm items must use free ids (114/115). See beta.46-fix-items.sql.
