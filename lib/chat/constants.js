...
module.exports.ChatConst = {
    ...
    SNIPPETS: {
        ...
        GLOBAL_MESSAGE_LIMIT_REACHED: snippetsPrefix+'globalLimitReached',
        GLOBAL_MESSAGE_PENDING: snippetsPrefix+'globalMessagePending',
        GLOBAL_MESSAGE_UNAVAILABLE: snippetsPrefix+'globalMessageUnavailable',
        PLAYER:{
        ...
        MODERATION_PERMISSION_DENIED: snippetsPrefix+'moderationPermissionDenied',
        MODERATION_COMMAND_USAGE: snippetsPrefix+'moderationCommandUsage',
        MODERATION_NOT_IMPLEMENTED: snippetsPrefix+'moderationNotImplemented',
        MODERATION_MUTED: snippetsPrefix+'moderationMuted',
        MODERATION_SUSPENDED: snippetsPrefix+'moderationSuspended',
        MODERATION_BANNED: snippetsPrefix+'moderationBanned',
        MODERATION_KICKED: snippetsPrefix+'moderationKicked',
        YOU_ARE_MUTED: snippetsPrefix+'youAreMuted',
        MESSAGE_BLOCKED: snippetsPrefix+'messageBlocked',
        WAITING: '...'
    },
    SELECTORS: {
