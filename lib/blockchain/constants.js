...
module.exports.BlockchainConst = {
    ...
    // Faucet defaults:
    FAUCET_DEFAULT_ENABLED: false,
    FAUCET_DEFAULT_COOLDOWN_SECONDS: 86400,
    FAUCET_DEFAULT_AMOUNT: 1,
    // NFT binding operation types:
    NFT_OP_BIND: 'bind',
    NFT_OP_BURN: 'burn',
    // NFT binding operation statuses:
    NFT_OP_STATUS_PENDING: 'pending',
    NFT_OP_STATUS_CONFIRMED: 'confirmed',
    NFT_OP_STATUS_FAILED: 'failed'
};
